...
export const defaultPrefixHint = $localize `@@settings.defaultPrefixHint:Used when creating new items.`;
...
export const defaultLabelSizeLabel = $localize `@@settings.defaultLabelSizeLabel:Default label size`;
export const labelSizeSmallOption = $localize `@@settings.labelSizeSmallOption:Small`;
export const labelSizeMediumOption = $localize `@@settings.labelSizeMediumOption:Medium`;
export const labelSizeLargeOption = $localize `@@settings.labelSizeLargeOption:Large`;
...
export const backupReminderLabel = $localize `@@settings.backupReminderLabel:Backup reminder`;
export const backupReminderOffOption = $localize `@@settings.backupReminderOffOption:Off`;
export const backupReminderWeekOption = $localize `@@settings.backupReminderWeekOption:Every 7 days`;
export const backupReminderMonthOption = $localize `@@settings.backupReminderMonthOption:Every 30 days`;
