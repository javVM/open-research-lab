export const FLOOR_PLAN_3D_I18N = {
  ariaLabel: { key: 'floorPlan3d.ariaLabel', fallback: '3D floor plan' },
  ...
  rotateLeft: { key: 'floorPlan3d.rotateLeft', fallback: 'Spin left' },
  rotateRight: { key: 'floorPlan3d.rotateRight', fallback: 'Spin right' },
} as const;
