export const LOCATION_VIEW_I18N = {
  ...
  trayRowsTitle: { key: 'locationView.trayRowsTitle', fallback: 'Tray rows' },
  trayRowsPrompt: { key: 'locationView.trayRowsPrompt', fallback: 'Number of rows:' },
  trayColumnsTitle: { key: 'locationView.trayColumnsTitle', fallback: 'Tray columns' },
  ...
  addButton: { key: 'locationView.addButton', fallback: 'Add' },
